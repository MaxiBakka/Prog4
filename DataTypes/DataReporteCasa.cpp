...
DataReporteCasa::DataReporteCasa(int c, int cda, int d, int b, bool g, string& dir, float iv, float ia, float m2E, float ev):DataReportePropiedad(c,cda,d,b,g,dir,iv,ia) {
