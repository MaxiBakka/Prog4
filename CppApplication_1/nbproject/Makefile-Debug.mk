...
${OBJECTDIR}/EdificioNoExistente.o: EdificioNoExistente.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/EdificioNoExistente.o EdificioNoExistente.cpp
...
${OBJECTDIR}/ExNoHayMensajes.o: ExNoHayMensajes.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ExNoHayMensajes.o ExNoHayMensajes.cpp
...
${OBJECTDIR}/ExisteEdificio.o: ExisteEdificio.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ExisteEdificio.o ExisteEdificio.cpp
...
${OBJECTDIR}/FechaInvalida.o: FechaInvalida.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FechaInvalida.o FechaInvalida.cpp

${OBJECTDIR}/HoraInvalida.o: HoraInvalida.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/HoraInvalida.o HoraInvalida.cpp
...
${OBJECTDIR}/NoExisteChat.o: NoExisteChat.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/NoExisteChat.o NoExisteChat.cpp
...
${OBJECTDIR}/NoHayChatEnMemoria.o: NoHayChatEnMemoria.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/NoHayChatEnMemoria.o NoHayChatEnMemoria.cpp

${OBJECTDIR}/NoHayConversaciones.o: NoHayConversaciones.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/NoHayConversaciones.o NoHayConversaciones.cpp

${OBJECTDIR}/NoHayDepartamentoEnMemoria.o: NoHayDepartamentoEnMemoria.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/NoHayDepartamentoEnMemoria.o NoHayDepartamentoEnMemoria.cpp
...
${OBJECTDIR}/NoHayPropiedades.o: NoHayPropiedades.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/NoHayPropiedades.o NoHayPropiedades.cpp

${OBJECTDIR}/PrecioInvalido.o: PrecioInvalido.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PrecioInvalido.o PrecioInvalido.cpp
...
${OBJECTDIR}/ValoresInvalidos.o: ValoresInvalidos.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ValoresInvalidos.o ValoresInvalidos.cpp
...
${OBJECTDIR}/YaExistePropiedad.o: YaExistePropiedad.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/YaExistePropiedad.o YaExistePropiedad.cpp
